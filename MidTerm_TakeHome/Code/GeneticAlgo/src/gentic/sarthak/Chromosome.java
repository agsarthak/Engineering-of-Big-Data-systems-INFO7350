...
public class Chromosome {
	...
	// Constructor that generates a random chromosome
	public Chromosome(int target, StringBuffer chromo) {
		...
		// Score the new chromo
		//scoreChromo(target);
	}
				
	public Chromosome(StringBuffer chromo) { this.chromo = chromo; }
